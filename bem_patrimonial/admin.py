...
from bem_patrimonial.admins.baixa_fisica_bem_patrimonial import BaixaFisicaBemPatrimonialAdmin
from bem_patrimonial.models import BemPatrimonial, MovimentacaoBemPatrimonial, BaixaFisicaBemPatrimonial
